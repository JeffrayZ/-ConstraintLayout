...
public class ZMLayoutHelper implements ZMLayout {
    ...
    private int mRadius;
    private @ZMLayout.HideRadiusSide int mHideRadiusSide = HIDE_RADIUS_SIDE_NONE;
    ...
    public ZMLayoutHelper(Context context, AttributeSet attrs, int defAttr, View owner) {
        this(context, attrs, defAttr, 0, owner);
    }

    public ZMLayoutHelper(Context context, AttributeSet attrs, int defAttr, int defStyleRes, View owner) {
        mContext = context;
        ...
        mShadowAlpha = ZMResHelper.getAttrFloatValue(context, R.attr.qmui_general_shadow_alpha);
        ...
        if (shadow == 0 && useThemeGeneralShadowElevation) {
            shadow = ZMResHelper.getAttrDimen(context, R.attr.qmui_general_shadow_elevation);
    ...
    public void setUseThemeGeneralShadowElevation() {
        mShadowElevation = ZMResHelper.getAttrDimen(mContext, R.attr.qmui_general_shadow_elevation);
    ...
    @Override
    public void setRadius(int radius, @ZMLayout.HideRadiusSide int hideRadiusSide) {
    ...
    @Override
    public void setRadiusAndShadow(int radius, @ZMLayout.HideRadiusSide int hideRadiusSide, int shadowElevation, float shadowAlpha) {
