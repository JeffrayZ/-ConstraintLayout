...
public class ZMConstraintLayout extends ConstraintLayout implements ZMLayout {
    private ZMLayoutHelper mLayoutHelper;

    public ZMConstraintLayout(Context context) {
        super(context);
        init(context, null, 0);
    }

    public ZMConstraintLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, 0);
    }

    public ZMConstraintLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs, defStyleAttr);
    }

    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        mLayoutHelper = new ZMLayoutHelper(context, attrs, defStyleAttr, this);
    }
